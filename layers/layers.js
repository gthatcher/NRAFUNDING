...
lyr_NRAgrantrecipients_0.set('fieldLabels', {'year': 'no label', 'Orginization': 'no label', 'grant_purpose': 'header label', 'cash_grant': 'header label', 'non_cash_grant': 'header label', });
