...
lyr_NRAgrantrecipients_0.set('fieldAliases', {'year': 'year', 'org_name': 'org_name', 'address': 'address', 'city': 'city', 'state': 'state', 'zip': 'zip', 'irc_section': 'irc_section', 'grant_purpose': 'grant_purpose', 'cash_grant': 'cash grant', 'non cash grant': 'non_cash_grant', 'total_grant': 'total_grant', 'county': 'county', 'fips': 'fips', 'urban_classification': 'urban_classification', 'school': 'school', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Accuracy Score': 'Accuracy Score', 'Accuracy Type': 'Accuracy Type', 'Number': 'Number', 'Street': 'Street', 'City_1': 'City_1', 'State_1': 'State_1', 'County_1': 'County_1', 'Zip_1': 'Zip_1', 'Country': 'Country', 'Source': 'Source', });
lyr_NRAgrantrecipients_0.set('fieldImages', {'year': 'TextEdit', 'org_name': 'TextEdit', 'address': 'Hidden', 'city': 'Hidden', 'state': 'Hidden', 'zip': 'Hidden', 'irc_section': 'Hidden', 'grant purpose': 'TextEdit', 'cash_grant': 'TextEdit', 'non cash grant': 'TextEdit', 'total_grant': 'Hidden', 'county': 'Hidden', 'fips': 'Hidden', 'urban_classification': 'Hidden', 'school': 'Hidden', 'Latitude': 'Hidden', 'Longitude': 'Hidden', 'Accuracy Score': 'Hidden', 'Accuracy Type': 'Hidden', 'Number': 'Hidden', 'Street': 'Hidden', 'City_1': 'Hidden', 'State_1': 'Hidden', 'County_1': 'Hidden', 'Zip_1': 'Hidden', 'Country': 'Hidden', 'Source': 'Hidden', });
lyr_NRAgrantrecipients_0.set('fieldLabels', {'year': 'no label', 'Orginization': 'no label', 'grant_purpose': 'header label', 'cash grant': 'header label', 'non cash grant': 'header label', });
